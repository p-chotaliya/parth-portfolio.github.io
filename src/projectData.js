const projects = [
  {
    title: "FileShare and Profit Analysis System",
    image: "./images/Fileshare.png",
    description:
      "This web app, built with Angular, Node.js, and MySQL, simplifies profit analysis by extracting data from uploaded Excel sheets. Analyze product profitability, view interactive dashboards, generate customizable reports, and ensure data security. Gain actionable insights to drive business success.",
    tools: [
      "Angular",
      "Node Js",
      "MySQL",
